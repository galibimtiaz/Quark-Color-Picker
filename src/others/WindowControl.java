...
public class WindowControl {
    ...
    private void createTrayIcon() {
        ...
        if (SystemTray.isSupported()) {
            ...
            // LOAD AN IMAGE
            java.awt.Image image = new ImageIcon(this.getClass().getResource("/icons/quark_Icon_small.png")).getImage();
            ...
            trayIcon = new TrayIcon(image, "Quark Color Picker", popup);
    ...
    private void showProgramIsMinimizedMsg() {
        if (firstTime) {
            trayIcon.displayMessage("Quark Color Picker is Still Running.",
